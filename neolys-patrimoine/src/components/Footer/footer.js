    ...
    <div className="footer">
        ...
        <div className='footer__contact__mentions'>
          <ul className='footer__contact__mentions__links'>
              ...
              <NavLink to="/mentions" target="_blank" className='footer__contact__mentions__links__link'> Mentions légales</NavLink>
                <br></br>
              <NavLink to="/" className='footer__contact__mentions__links__link'> Politique de Confidentialité</NavLink>
              <br></br>
              <NavLink to="/" className='footer__contact__mentions__links__link'> CGU</NavLink>
